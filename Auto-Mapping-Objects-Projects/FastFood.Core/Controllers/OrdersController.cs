namespace FastFood.Core.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public IActionResult Create(CreateOrderInputModel model)
        {
            ...
            {
                return this.RedirectToAction("Erorr", "Home");
            }
        ...
        {
            List<OrderAllViewModel> orders = this.context.Orders.ProjectTo<OrderAllViewModel>(this.mapper.ConfigurationProvider).ToList();
