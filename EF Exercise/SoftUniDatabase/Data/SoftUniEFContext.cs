...
{
    public partial class SoftUniEFContext : DbContext
    {
        public SoftUniEFContext()
        {
        }

        public SoftUniEFContext(DbContextOptions<SoftUniEFContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-VLH0QE3\\SQLEXPRESS03;Database=SoftUniEF;Integrated Security=True;");
            }
        }
