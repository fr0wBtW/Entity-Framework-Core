...
namespace RealEstates.Web.Controllers
{
    public class DistrictsController : Controller
    {
        ...
        public DistrictsController(RealEstateDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Districts != null ? 
                          ...
                          Problem("Entity set 'RealEstateDbContext.Districts'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RealEstateDbContext.Districts'  is null.");
            }
            var district = await _context.Districts.FindAsync(id);
            if (district != null)
            {
